...
local XmlParser = require('dash.utils.xml2lua.XmlParser')
...
-- @param fieldValue a field from the lua table to be recursively parsed to XML or a primitive
--        value that will be enclosed in a tag name
